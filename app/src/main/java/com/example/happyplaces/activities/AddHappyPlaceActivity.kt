...
import com.example.happyplaces.databinding.DialogCustomBackConfirmationBinding
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun customDialogForBackButton() {
        ...
        dialogBinding.btnYes.setOnClickListener {
            this@AddHappyPlaceActivity.finish()
    ...
    private fun takePhotoFromCamera() {
        Dexter.withActivity(this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA).withListener(object :
    ...
    private fun showRationalDialogForPermissions() {
        AlertDialog.Builder(this).setMessage("It looks like you have turned off permissions. It can be turned on in the Applications Settings").setPositiveButton("GO TO SETTINGS")
        { _, _ ->
                try {
